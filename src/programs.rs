...
pub static PROGRAMS: &[BuiltinProgram] = &[
    BuiltinProgram { name: "aleph_lattice_extrema.aleph", data: include_bytes!("../programs/aleph_lattice_extrema.aleph") },
    BuiltinProgram { name: "belnap_shor_orbit.aleph", data: include_bytes!("../programs/belnap_shor_orbit.aleph") },
    BuiltinProgram { name: "conflict_landscape.aleph", data: include_bytes!("../programs/conflict_landscape.aleph") },
    ...
    BuiltinProgram { name: "cross_pole_mediation.aleph", data: include_bytes!("../programs/cross_pole_mediation.aleph") },
    BuiltinProgram { name: "dialetheic_fixed_points.aleph", data: include_bytes!("../programs/dialetheic_fixed_points.aleph") },
    BuiltinProgram { name: "distance_matrix.aleph", data: include_bytes!("../programs/distance_matrix.aleph") },
    ...
    BuiltinProgram { name: "invariant_check.aleph", data: include_bytes!("../programs/invariant_check.aleph") },
    BuiltinProgram { name: "letter_sefirah_projection.aleph", data: include_bytes!("../programs/letter_sefirah_projection.aleph") },
    ...
    BuiltinProgram { name: "mediate_lattice.aleph", data: include_bytes!("../programs/mediate_lattice.aleph") },
    BuiltinProgram { name: "meditation.aleph", data: include_bytes!("../programs/meditation.aleph") },
    BuiltinProgram { name: "palace_stress_test.aleph", data: include_bytes!("../programs/palace_stress_test.aleph") },
    ...
    BuiltinProgram { name: "primitive_landscape.aleph", data: include_bytes!("../programs/primitive_landscape.aleph") },
    ...
    BuiltinProgram { name: "sefirah_distance_matrix.aleph", data: include_bytes!("../programs/sefirah_distance_matrix.aleph") },
    BuiltinProgram { name: "sefirah_emanation_ladder.aleph", data: include_bytes!("../programs/sefirah_emanation_ladder.aleph") },
    ...
    BuiltinProgram { name: "tier_boundary_probe.aleph", data: include_bytes!("../programs/tier_boundary_probe.aleph") },
    BuiltinProgram { name: "tier_migration.aleph", data: include_bytes!("../programs/tier_migration.aleph") },
    ...
    BuiltinProgram { name: "truth_structure.aleph", data: include_bytes!("../programs/truth_structure.aleph") },
];
