...
\begin{lstlisting}
kernel object:  tier=O₂  odot_c  Omega_Z  Phi_sym    C=0.727
user object:    tier=O₀  odot_sub  Omega_0  Phi_asym  C=0.000
...
\medskip
Gate checks at boot confirm the expected structure. IPC to Keter is denied for user objects ($O₀$, $\Phi_{\text{asym}}$). $\Omega$ gate allows Velar+Kernel and denies Velar+User. $\Phi$ gate allows Keter+Driver and denies Keter+User.
...
──────────────────────────────────────────────────────────
vav       vav              O_∞       0.0000   [closed]
mem       mem              O_∞       0.0000   [closed]
shin      shin             O_∞       0.0000   [closed]
aleph     aleph            O₂         0.0000   [closed]
dalet     dalet            O₀         0.0000   [closed]
tav       tav              O₂         0.0000   [closed]
──────────────────────────────────────────────────────────
