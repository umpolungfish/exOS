...
\node[font=\tiny, below=0.1cm of erg1, align=left, text=gray!70!black] (erg_desc) {
  ...
  $O₂$ ergative: +12 priority\\
  $O₁$ ergative: +10 priority\\
  $O₀$ ergative: \textcolor{red!70!black}{gated (spawn\_type\_safe)}
};
...
\node[tier, fill=yellow!20, draw=yellow!70!black, below=0.15cm of tinf] (t2) {$O₂$ +12};
\node[tier, fill=green!15, draw=green!60!black, below=0.15cm of t2] (t2d) {$O_{2}^{\dagger}$ +12};
\node[tier, fill=blue!10, draw=blue!60!black, below=0.15cm of t2d] (t1) {$O₁$ +10};
\node[tier, fill=gray!20, draw=gray!60!black, below=0.15cm of t1] (t0) {$O₀$ +0 \textcolor{red!70!black}{gated}};
...
\node[rectangle, draw, thick, rounded corners, fill=purple!10, minimum width=3.5cm, minimum height=1.8cm,
  ...
  5. $O₀$ with targets: spawn\_type\_safe $\to$ deny
};
